...
export const SubTitle = ({ title, subTitle, titleSize, subTitleSize }) => {
  return (
    <View>
...
export const People = () => {
  return (
    <View style={{ flexDirection: "row" }} >
      {[assets.person02, assets.person03, assets.person04].map((image, index) => {
        return <Image
          source={image}
          resizeMode="contain"
          style={{
